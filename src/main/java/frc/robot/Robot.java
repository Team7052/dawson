...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    motorControllerleft.set(leftSpeed);
    */

   /*  double controls = -controller.getRawAxis(1); 
   if (controls > 0.2 || controls < -0.2) {
      motorControllerleft.set(controls);
      motorControllerright.set(controls);
    }
    else {
      motorControllerleft.set(0);
      motorControllerright.set(0);
    }

    double controls2=controller.getRawAxis(0);

    if (controls2>0.2 || controls2 < -0.2) {
      motorControllerleft.set(controls2);
      motorControllerright.set(-controls2);
    }
    */
